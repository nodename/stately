...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__55526_SHARP_){
return (nodename.stately.tree.state_tree.cljs$core$IFn$_invoke$arity$2 ? nodename.stately.tree.state_tree.cljs$core$IFn$_invoke$arity$2(state_machines,p1__55526_SHARP_) : nodename.stately.tree.state_tree.call(null, state_machines,p1__55526_SHARP_));
...
return cljs.core.PersistentArrayMap.createAsIfByAssoc([root_fsm_key,cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.merge,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__55527_SHARP_){
return key_and_components(p1__55527_SHARP_,root_fsm);
...
var trees = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__55533_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(m,p1__55533_SHARP_);
}),ks);
var sub_kvs = cljs.core.map.cljs$core$IFn$_invoke$arity$3((function (p1__55534_SHARP_,p2__55535_SHARP_){
return (nodename.stately.tree.parent_links.cljs$core$IFn$_invoke$arity$2 ? nodename.stately.tree.parent_links.cljs$core$IFn$_invoke$arity$2(p1__55534_SHARP_,p2__55535_SHARP_) : nodename.stately.tree.parent_links.call(null, p1__55534_SHARP_,p2__55535_SHARP_));
}),trees,ks);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [state_kw], null),(function (){var G__55559 = nodename.stately.tree.super$(state_kw);
return (nodename.stately.tree.path_to_root.cljs$core$IFn$_invoke$arity$1 ? nodename.stately.tree.path_to_root.cljs$core$IFn$_invoke$arity$1(G__55559) : nodename.stately.tree.path_to_root.call(null, G__55559));
})());
}
});
/**
...
var G__55583 = cljs.core.rest(exit);
var G__55584 = cljs.core.rest(entrance);
exit = G__55583;
entrance = G__55584;
continue;
} else {
