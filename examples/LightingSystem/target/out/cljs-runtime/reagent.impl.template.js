...
var G__51972 = o;
reagent.impl.template.goog$module$goog$object.set(G__51972,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
G__52371.cljs$lang$applyTo = (function (arglist__52374){
...
var G__51996 = o;
reagent.impl.template.goog$module$goog$object.set(G__51996,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__52381__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__52381 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__52382__i = 0, G__52382__a = new Array(arguments.length -  0);
while (G__52382__i < G__52382__a.length) {G__52382__a[G__52382__i] = arguments[G__52382__i + 0]; ++G__52382__i;}
  args = new cljs.core.IndexedSeq(G__52382__a,0,null);
} 
return G__52381__delegate.call(this,args);};
G__52381.cljs$lang$maxFixedArity = 0;
G__52381.cljs$lang$applyTo = (function (arglist__52383){
var args = cljs.core.seq(arglist__52383);
return G__52381__delegate(args);
});
G__52381.cljs$core$IFn$_invoke$arity$variadic = G__52381__delegate;
return G__52381;
})()
;
} else {
...
var G__52010 = props;
var G__52010__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52010,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__52010);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52010__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__52022 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52022,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__52022;
}
})(),id_class);
...
var temp__5804__auto___52385 = (function (){var and__5000__auto__ = js_props;
...
if(cljs.core.truth_(temp__5804__auto___52385)){
var d_52386 = temp__5804__auto___52385;
if((d_52386 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_52386.s}));
} else {
...
var G__52034 = (cljs.core.count(argv) - first_child);
switch (G__52034) {
case (0):
...
var temp__5808__auto___52394 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___52394 == null)){
} else {
var key_52395 = temp__5808__auto___52394;
(jsprops.key = key_52395);
}
...
var temp__5808__auto___52402 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___52402 == null)){
} else {
var key_52403 = temp__5808__auto___52402;
(jsprops.key = key_52403);
}
...
var temp__5808__auto___52406 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___52406 == null)){
} else {
var key_52410 = temp__5808__auto___52406;
(jsprops.key = key_52410);
}
...
var temp__5808__auto___52438 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___52438 == null)){
} else {
var key_52439 = temp__5808__auto___52438;
(jsprops.key = key_52439);
}
...
var temp__5808__auto___52449 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___52449 == null)){
} else {
var key_52452 = temp__5808__auto___52449;
(jsprops.key = key_52452);
}
...
var temp__5808__auto___52455 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___52455 == null)){
} else {
var key_52456 = temp__5808__auto___52455;
(jsprops.key = key_52456);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52200_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__52200_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__52215 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52215,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52215,(1),null);
...
break;
default:
var G__52470 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__52471 = compiler;
v = G__52470;
compiler = G__52471;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template52322 = (function (opts,id,fn_to_element,parse_fn,meta52323){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template52322.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_52324,meta52323__$1){
var self__ = this;
var _52324__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template52322(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta52323__$1));
}));

(reagent.impl.template.t_reagent$impl$template52322.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_52324){
var self__ = this;
var _52324__$1 = this;
return self__.meta52323;
}));

(reagent.impl.template.t_reagent$impl$template52322.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template52322.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template52322.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template52322.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template52322.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template52322.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta52323","meta52323",1893787990,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template52322.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template52322.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template52322");

(reagent.impl.template.t_reagent$impl$template52322.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template52322");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template52322.
 */
reagent.impl.template.__GT_t_reagent$impl$template52322 = (function reagent$impl$template$__GT_t_reagent$impl$template52322(opts,id,fn_to_element,parse_fn,meta52323){
return (new reagent.impl.template.t_reagent$impl$template52322(opts,id,fn_to_element,parse_fn,meta52323));
});
...
return (new reagent.impl.template.t_reagent$impl$template52322(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
