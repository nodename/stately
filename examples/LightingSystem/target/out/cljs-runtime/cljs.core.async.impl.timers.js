...
var i_51761 = (0);
while(true){
if((i_51761 < arr.length)){
(arr[i_51761] = null);

var G__51762 = (i_51761 + (1));
i_51761 = G__51762;
continue;
} else {
}
...
var i_51776 = (self__.level + (1));
while(true){
if((i_51776 <= (new_level + (1)))){
(update[i_51776] = self__.header);

var G__51777 = (i_51776 + (1));
i_51776 = G__51777;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_51783 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_51783[i]));
} else {
x__$2.forward.push((((i < links_51783.length))?(links_51783[i]):null));
}

if((i < links_51783.length)){
(links_51783[i] = x__$2);
} else {
links_51783.push(x__$2);
}
...
var i_51789 = (0);
while(true){
if((i_51789 <= self__.level)){
var links_51791 = (update[i_51789]).forward;
if((x__$1 === (((i_51789 < links_51791.length))?(links_51791[i_51789]):null))){
(links_51791[i_51789] = (x__$1.forward[i_51789]));

var G__51795 = (i_51789 + (1));
i_51789 = G__51795;
continue;
} else {
var G__51797 = (i_51789 + (1));
i_51789 = G__51797;
continue;
}
} else {
...
var G__51805 = nx;
var G__51806 = (level__$1 - (1));
x = G__51805;
level__$1 = G__51806;
continue;
} else {
var G__51808 = x;
var G__51809 = (level__$1 - (1));
x = G__51808;
level__$1 = G__51809;
continue;
}
