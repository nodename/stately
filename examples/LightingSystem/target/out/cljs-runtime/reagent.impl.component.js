...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__51514 = c;
var G__51514__$1 = (((G__51514 == null))?null:G__51514.prototype);
if((G__51514__$1 == null)){
return null;
} else {
return G__51514__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__51519 = c;
var G__51519__$1 = (((G__51519 == null))?null:G__51519.prototype);
if((G__51519__$1 == null)){
return null;
} else {
return G__51519__$1.render;
}
})() == null)))));
});
...
var or__5002__auto__ = (function (){var G__51605 = c;
var G__51605__$1 = (((G__51605 == null))?null:G__51605.constructor);
if((G__51605__$1 == null)){
return null;
} else {
return G__51605__$1.displayName;
}
})();
...
var G__51613 = c;
var G__51613__$1 = (((G__51613 == null))?null:G__51613.constructor);
if((G__51613__$1 == null)){
return null;
} else {
return G__51613__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__51621 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__51622 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__51622);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__51621);
}});
...
var G__51660 = reagent.impl.component.goog$module$goog$object.get(component_state,"cljsRatom");
if((G__51660 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__51660);
}
} else {
return null;
}
...
var renders_51888 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_51889 = cljs.core.first(cljs.core.vals(renders_51888));
...
if((cljs.core.count(renders_51888) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_51888))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_51889)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_51889], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__51751 = o;
reagent.impl.component.goog$module$goog$object.set(G__51751,cljs.core.name(k),v);
...
return (function() { 
var G__51904__delegate = function (args){
return reagent.impl.protocols.as_element(compiler,cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args));
};
var G__51904 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__51906__i = 0, G__51906__a = new Array(arguments.length -  0);
while (G__51906__i < G__51906__a.length) {G__51906__a[G__51906__i] = arguments[G__51906__i + 0]; ++G__51906__i;}
  args = new cljs.core.IndexedSeq(G__51906__a,0,null);
} 
return G__51904__delegate.call(this,args);};
G__51904.cljs$lang$maxFixedArity = 0;
G__51904.cljs$lang$applyTo = (function (arglist__51907){
var args = cljs.core.seq(arglist__51907);
return G__51904__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__51837 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__51838 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__51838);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__51837);
}});
...
var vec__51853 = module$node_modules$react$index.useReducer(cljs.core.inc,(0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51853,(0),null);
var force_update = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51853,(1),null);
