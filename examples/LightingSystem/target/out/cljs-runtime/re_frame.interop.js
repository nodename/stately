...
return [(function (){var pred__52934 = cljs.core.instance_QMARK_;
var expr__52935 = reactive_val;
if(cljs.core.truth_((pred__52934.cljs$core$IFn$_invoke$arity$2 ? pred__52934.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__52935) : pred__52934.call(null, reagent.ratom.RAtom,expr__52935)))){
return "ra";
} else {
if(cljs.core.truth_((pred__52934.cljs$core$IFn$_invoke$arity$2 ? pred__52934.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__52935) : pred__52934.call(null, reagent.ratom.RCursor,expr__52935)))){
return "rc";
} else {
if(cljs.core.truth_((pred__52934.cljs$core$IFn$_invoke$arity$2 ? pred__52934.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__52935) : pred__52934.call(null, reagent.ratom.Reaction,expr__52935)))){
return "rx";
} else {
if(cljs.core.truth_((pred__52934.cljs$core$IFn$_invoke$arity$2 ? pred__52934.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__52935) : pred__52934.call(null, reagent.ratom.Track,expr__52935)))){
return "tr";
} else {
return "other";
}
