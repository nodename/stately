...
nodename.stately.communications.re_frame_api.log = (function nodename$stately$communications$re_frame_api$log(p1__55327_SHARP_){
return console.log(p1__55327_SHARP_);
});
nodename.stately.communications.re_frame_api.warn = (function nodename$stately$communications$re_frame_api$warn(p1__55329_SHARP_){
return console.warn(p1__55329_SHARP_);
});
nodename.stately.communications.re_frame_api.error = (function nodename$stately$communications$re_frame_api$error(p1__55330_SHARP_){
return console.error(p1__55330_SHARP_);
});
