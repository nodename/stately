goog.provide('lightingsystem.ui.app');
...
lightingsystem.ui.app.small_button_style = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"padding","padding",1660304693),"4px 10px",new cljs.core.Keyword(null,"margin-right","margin-right",809689658),"6px",new cljs.core.Keyword(null,"cursor","cursor",1011937484),"pointer",new cljs.core.Keyword(null,"font-size","font-size",-1847940346),"12px"], null);
lightingsystem.ui.app.bulb = (function lightingsystem$ui$app$bulb(brightness){
...
lightingsystem.ui.app.btn = (function lightingsystem$ui$app$btn(var_args){
var args__5732__auto__ = [];
var len__5726__auto___58792 = arguments.length;
var i__5727__auto___58793 = (0);
while(true){
if((i__5727__auto___58793 < len__5726__auto___58792)){
args__5732__auto__.push((arguments[i__5727__auto___58793]));

var G__58794 = (i__5727__auto___58793 + (1));
i__5727__auto___58793 = G__58794;
continue;
} else {
}
break;
...
return lightingsystem.ui.app.btn.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__5733__auto__);
});

(lightingsystem.ui.app.btn.cljs$core$IFn$_invoke$arity$variadic = (function (label,event,p__58787){
var vec__58788 = p__58787;
var map__58791 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58788,(0),null);
var map__58791__$1 = cljs.core.__destructure_map(map__58791);
var disabled_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58791__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
...
(lightingsystem.ui.app.btn.cljs$lang$maxFixedArity = (2));

/** @this {Function} */
(lightingsystem.ui.app.btn.cljs$lang$applyTo = (function (seq58784){
var G__58785 = cljs.core.first(seq58784);
var seq58784__$1 = cljs.core.next(seq58784);
var G__58786 = cljs.core.first(seq58784__$1);
var seq58784__$2 = cljs.core.next(seq58784__$1);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__58785,G__58786,seq58784__$2);
}));

lightingsystem.ui.app.app_screen = (function lightingsystem$ui$app$app_screen(){
...
})], null),"db"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button","button",1456579943),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"style","style",-496642736),lightingsystem.ui.app.small_button_style,new cljs.core.Keyword(null,"on-click","on-click",1632826543),cljs.user.show_active_states], null),"active states"], null)], null)], null);
});
});

//# sourceMappingURL=lightingsystem.ui.app.js.map
