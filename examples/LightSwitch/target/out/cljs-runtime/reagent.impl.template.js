...
var G__33067 = o;
reagent.impl.template.goog$module$goog$object.set(G__33067,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
while (G__33384__i < G__33384__a.length) {G__33384__a[G__33384__i] = arguments[G__33384__i + 0]; ++G__33384__i;}
  args = new cljs.core.IndexedSeq(G__33384__a,0,null);
} 
...
var args = cljs.core.seq(arglist__33385);
...
var G__33091 = o;
reagent.impl.template.goog$module$goog$object.set(G__33091,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__33099 = props;
var G__33099__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33099,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__33099);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33099__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__33106 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33106,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__33106;
}
})(),id_class);
...
var temp__5804__auto___33400 = (function (){var and__5000__auto__ = js_props;
...
if(cljs.core.truth_(temp__5804__auto___33400)){
var d_33404 = temp__5804__auto___33400;
if((d_33404 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_33404.s}));
} else {
...
var G__33132 = (cljs.core.count(argv) - first_child);
switch (G__33132) {
case (0):
...
var vec__33144 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33144,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33144,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33144,(2),null);
...
var temp__5808__auto___33418 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___33418 == null)){
} else {
var key_33419 = temp__5808__auto___33418;
(jsprops.key = key_33419);
}
...
var temp__5808__auto___33421 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___33421 == null)){
} else {
var key_33422 = temp__5808__auto___33421;
(jsprops.key = key_33422);
}
...
var temp__5808__auto___33423 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___33423 == null)){
} else {
var key_33424 = temp__5808__auto___33423;
(jsprops.key = key_33424);
}
...
var temp__5808__auto___33432 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___33432 == null)){
} else {
var key_33433 = temp__5808__auto___33432;
(jsprops.key = key_33433);
}
...
var temp__5808__auto___33444 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___33444 == null)){
} else {
var key_33445 = temp__5808__auto___33444;
(jsprops.key = key_33445);
}
...
var temp__5808__auto___33447 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___33447 == null)){
} else {
var key_33450 = temp__5808__auto___33447;
(jsprops.key = key_33450);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__33265_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__33265_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__33284 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33284,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33284,(1),null);
...
break;
default:
var G__33460 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__33461 = compiler;
v = G__33460;
compiler = G__33461;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template33334 = (function (opts,id,fn_to_element,parse_fn,meta33335){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template33334.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_33336,meta33335__$1){
var self__ = this;
var _33336__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template33334(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta33335__$1));
}));

(reagent.impl.template.t_reagent$impl$template33334.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_33336){
var self__ = this;
var _33336__$1 = this;
return self__.meta33335;
}));

(reagent.impl.template.t_reagent$impl$template33334.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template33334.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template33334.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template33334.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template33334.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template33334.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta33335","meta33335",959105506,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template33334.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template33334.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template33334");

(reagent.impl.template.t_reagent$impl$template33334.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template33334");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template33334.
 */
reagent.impl.template.__GT_t_reagent$impl$template33334 = (function reagent$impl$template$__GT_t_reagent$impl$template33334(opts,id,fn_to_element,parse_fn,meta33335){
return (new reagent.impl.template.t_reagent$impl$template33334(opts,id,fn_to_element,parse_fn,meta33335));
});
...
return (new reagent.impl.template.t_reagent$impl$template33334(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
