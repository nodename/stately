...
var i_32584 = (0);
while(true){
if((i_32584 < arr.length)){
(arr[i_32584] = null);

var G__32586 = (i_32584 + (1));
i_32584 = G__32586;
continue;
} else {
}
...
var i_32594 = (self__.level + (1));
while(true){
if((i_32594 <= (new_level + (1)))){
(update[i_32594] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_32596 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_32596[i]));
} else {
x__$2.forward.push((((i < links_32596.length))?(links_32596[i]):null));
}

if((i < links_32596.length)){
(links_32596[i] = x__$2);
} else {
links_32596.push(x__$2);
}
...
var i_32600 = (0);
while(true){
if((i_32600 <= self__.level)){
var links_32601 = (update[i_32600]).forward;
if((x__$1 === (((i_32600 < links_32601.length))?(links_32601[i_32600]):null))){
(links_32601[i_32600] = (x__$1.forward[i_32600]));

var G__32602 = (i_32600 + (1));
i_32600 = G__32602;
continue;
} else {
var G__32603 = (i_32600 + (1));
i_32600 = G__32603;
continue;
}
} else {
...
var G__32606 = nx;
var G__32607 = (level__$1 - (1));
x = G__32606;
level__$1 = G__32607;
continue;
} else {
var G__32608 = x;
var G__32609 = (level__$1 - (1));
x = G__32608;
level__$1 = G__32609;
continue;
}
