...
nodename.stately.communications.re_frame_api.log = (function nodename$stately$communications$re_frame_api$log(p1__36413_SHARP_){
return console.log(p1__36413_SHARP_);
});
nodename.stately.communications.re_frame_api.warn = (function nodename$stately$communications$re_frame_api$warn(p1__36416_SHARP_){
return console.warn(p1__36416_SHARP_);
});
nodename.stately.communications.re_frame_api.error = (function nodename$stately$communications$re_frame_api$error(p1__36419_SHARP_){
