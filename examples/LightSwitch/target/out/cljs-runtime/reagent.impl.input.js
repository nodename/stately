...
var G__32975 = shadow_root.activeElement;
active_element = G__32975;
continue;
} else {
...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__32894){
var map__32897 = p__32894;
var map__32897__$1 = cljs.core.__destructure_map(map__32897);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32897__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
var _STAR_force_set_dom_value_STAR__orig_val__32901 = reagent.impl.input._STAR_force_set_dom_value_STAR_;
var _STAR_force_set_dom_value_STAR__temp_val__32902 = true;
(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__temp_val__32902);
...
}finally {(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__orig_val__32901);
}}));
} else {
...
(jsprops.onChange = (function (p1__32944_SHARP_){
return reagent.impl.input.input_handle_change(this$,on_change,p1__32944_SHARP_);
}));
