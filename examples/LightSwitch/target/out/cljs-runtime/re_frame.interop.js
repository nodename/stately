...
return [(function (){var pred__33866 = cljs.core.instance_QMARK_;
var expr__33867 = reactive_val;
if(cljs.core.truth_((pred__33866.cljs$core$IFn$_invoke$arity$2 ? pred__33866.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__33867) : pred__33866.call(null, reagent.ratom.RAtom,expr__33867)))){
return "ra";
} else {
if(cljs.core.truth_((pred__33866.cljs$core$IFn$_invoke$arity$2 ? pred__33866.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__33867) : pred__33866.call(null, reagent.ratom.RCursor,expr__33867)))){
return "rc";
} else {
if(cljs.core.truth_((pred__33866.cljs$core$IFn$_invoke$arity$2 ? pred__33866.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__33867) : pred__33866.call(null, reagent.ratom.Reaction,expr__33867)))){
return "rx";
} else {
if(cljs.core.truth_((pred__33866.cljs$core$IFn$_invoke$arity$2 ? pred__33866.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__33867) : pred__33866.call(null, reagent.ratom.Track,expr__33867)))){
return "tr";
} else {
return "other";
}
