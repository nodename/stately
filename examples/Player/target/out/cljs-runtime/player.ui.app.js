...
player.ui.app.small_button_style = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"padding","padding",1660304693),"4px 10px",new cljs.core.Keyword(null,"margin-right","margin-right",809689658),"6px",new cljs.core.Keyword(null,"cursor","cursor",1011937484),"pointer",new cljs.core.Keyword(null,"font-size","font-size",-1847940346),"12px"], null);
player.ui.app.btn = (function player$ui$app$btn(var_args){
var args__5732__auto__ = [];
var len__5726__auto___68255 = arguments.length;
var i__5727__auto___68256 = (0);
while(true){
if((i__5727__auto___68256 < len__5726__auto___68255)){
args__5732__auto__.push((arguments[i__5727__auto___68256]));

var G__68257 = (i__5727__auto___68256 + (1));
i__5727__auto___68256 = G__68257;
continue;
} else {
}
break;
...
return player.ui.app.btn.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__5733__auto__);
});

(player.ui.app.btn.cljs$core$IFn$_invoke$arity$variadic = (function (label,event,p__68247){
var vec__68248 = p__68247;
var map__68251 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68248,(0),null);
var map__68251__$1 = cljs.core.__destructure_map(map__68251);
var disabled_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68251__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
...
(player.ui.app.btn.cljs$lang$maxFixedArity = (2));

/** @this {Function} */
(player.ui.app.btn.cljs$lang$applyTo = (function (seq68244){
var G__68245 = cljs.core.first(seq68244);
var seq68244__$1 = cljs.core.next(seq68244);
var G__68246 = cljs.core.first(seq68244__$1);
var seq68244__$2 = cljs.core.next(seq68244__$1);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__68245,G__68246,seq68244__$2);
}));

player.ui.app.app_screen = (function player$ui$app$app_screen(){
...
})], null),"db"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button","button",1456579943),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"style","style",-496642736),player.ui.app.small_button_style,new cljs.core.Keyword(null,"on-click","on-click",1632826543),cljs.user.show_active_states], null),"active states"], null)], null)], null);
});
});

//# sourceMappingURL=player.ui.app.js.map
