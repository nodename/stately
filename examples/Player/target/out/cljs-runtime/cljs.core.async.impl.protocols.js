...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_60675 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_60675(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_60680 = (function (port,val,fn1_handler){
var x__5350__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_60680(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_60682 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_60682(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_60684 = (function (chan){
var x__5350__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_60684(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_60686 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_60686(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_60689 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_60689(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_60691 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_60691(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_60694 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_60694(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_60695 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_60695(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_60696 = (function (b,itm){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_60696(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_60697 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_60697(b);
}
});
