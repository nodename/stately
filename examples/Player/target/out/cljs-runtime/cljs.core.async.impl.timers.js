...
var i_61076 = (0);
while(true){
if((i_61076 < arr.length)){
(arr[i_61076] = null);

var G__61078 = (i_61076 + (1));
i_61076 = G__61078;
continue;
} else {
}
...
var i_61095 = (self__.level + (1));
while(true){
if((i_61095 <= (new_level + (1)))){
(update[i_61095] = self__.header);

var G__61097 = (i_61095 + (1));
i_61095 = G__61097;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_61101 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_61101[i]));
} else {
x__$2.forward.push((((i < links_61101.length))?(links_61101[i]):null));
}

if((i < links_61101.length)){
(links_61101[i] = x__$2);
} else {
links_61101.push(x__$2);
}
...
var i_61107 = (0);
while(true){
if((i_61107 <= self__.level)){
var links_61110 = (update[i_61107]).forward;
if((x__$1 === (((i_61107 < links_61110.length))?(links_61110[i_61107]):null))){
(links_61110[i_61107] = (x__$1.forward[i_61107]));

var G__61112 = (i_61107 + (1));
i_61107 = G__61112;
continue;
} else {
var G__61113 = (i_61107 + (1));
i_61107 = G__61113;
continue;
}
} else {
...
var G__61120 = nx;
var G__61121 = (level__$1 - (1));
x = G__61120;
level__$1 = G__61121;
continue;
} else {
var G__61123 = x;
var G__61124 = (level__$1 - (1));
x = G__61123;
level__$1 = G__61124;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__61128 = nx;
var G__61129 = (level__$1 - (1));
x = G__61128;
level__$1 = G__61129;
continue;
} else {
var G__61130 = x;
var G__61131 = (level__$1 - (1));
x = G__61130;
level__$1 = G__61131;
continue;
}
