...
var G__61285 = o;
reagent.impl.template.goog$module$goog$object.set(G__61285,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
return (function() { 
var G__61498__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__61498 = function (var_args){
var args = null;
...
while (G__61499__i < G__61499__a.length) {G__61499__a[G__61499__i] = arguments[G__61499__i + 0]; ++G__61499__i;}
  args = new cljs.core.IndexedSeq(G__61499__a,0,null);
} 
return G__61498__delegate.call(this,args);};
G__61498.cljs$lang$maxFixedArity = 0;
G__61498.cljs$lang$applyTo = (function (arglist__61503){
var args = cljs.core.seq(arglist__61503);
return G__61498__delegate(args);
});
G__61498.cljs$core$IFn$_invoke$arity$variadic = G__61498__delegate;
return G__61498;
})()
;
} else {
...
var G__61301 = o;
reagent.impl.template.goog$module$goog$object.set(G__61301,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__61516__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__61516 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__61519__i = 0, G__61519__a = new Array(arguments.length -  0);
while (G__61519__i < G__61519__a.length) {G__61519__a[G__61519__i] = arguments[G__61519__i + 0]; ++G__61519__i;}
  args = new cljs.core.IndexedSeq(G__61519__a,0,null);
} 
return G__61516__delegate.call(this,args);};
G__61516.cljs$lang$maxFixedArity = 0;
G__61516.cljs$lang$applyTo = (function (arglist__61520){
var args = cljs.core.seq(arglist__61520);
return G__61516__delegate(args);
});
G__61516.cljs$core$IFn$_invoke$arity$variadic = G__61516__delegate;
return G__61516;
})()
;
} else {
...
var G__61306 = props;
var G__61306__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61306,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__61306);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61306__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__61312 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61312,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__61312;
}
})(),id_class);
...
var temp__5804__auto___61534 = (function (){var and__5000__auto__ = js_props;
...
if(cljs.core.truth_(temp__5804__auto___61534)){
var d_61535 = temp__5804__auto___61534;
if((d_61535 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_61535.s}));
} else {
...
var G__61314 = (cljs.core.count(argv) - first_child);
switch (G__61314) {
case (0):
...
var vec__61331 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61331,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61331,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61331,(2),null);
...
var temp__5808__auto___61547 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___61547 == null)){
} else {
var key_61549 = temp__5808__auto___61547;
(jsprops.key = key_61549);
}
...
var temp__5808__auto___61552 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___61552 == null)){
} else {
var key_61553 = temp__5808__auto___61552;
(jsprops.key = key_61553);
}
...
var temp__5808__auto___61556 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___61556 == null)){
} else {
var key_61558 = temp__5808__auto___61556;
...
var temp__5808__auto___61560 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___61560 == null)){
} else {
var key_61561 = temp__5808__auto___61560;
(jsprops.key = key_61561);
}
...
var temp__5808__auto___61585 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___61585 == null)){
} else {
var key_61587 = temp__5808__auto___61585;
(jsprops.key = key_61587);
}
...
var temp__5808__auto___61590 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___61590 == null)){
} else {
var key_61591 = temp__5808__auto___61590;
(jsprops.key = key_61591);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__61386_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__61386_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__61395 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61395,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61395,(1),null);
...
break;
default:
var G__61599 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__61600 = compiler;
v = G__61599;
compiler = G__61600;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template61470 = (function (opts,id,fn_to_element,parse_fn,meta61471){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template61470.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61472,meta61471__$1){
var self__ = this;
var _61472__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template61470(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta61471__$1));
}));

(reagent.impl.template.t_reagent$impl$template61470.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61472){
var self__ = this;
var _61472__$1 = this;
return self__.meta61471;
}));

(reagent.impl.template.t_reagent$impl$template61470.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template61470.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template61470.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template61470.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template61470.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template61470.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta61471","meta61471",-1930996782,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template61470.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template61470.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template61470");

(reagent.impl.template.t_reagent$impl$template61470.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template61470");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template61470.
 */
reagent.impl.template.__GT_t_reagent$impl$template61470 = (function reagent$impl$template$__GT_t_reagent$impl$template61470(opts,id,fn_to_element,parse_fn,meta61471){
return (new reagent.impl.template.t_reagent$impl$template61470(opts,id,fn_to_element,parse_fn,meta61471));
});
...
return (new reagent.impl.template.t_reagent$impl$template61470(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
