...
nodename.stately.communications.re_frame_api.log = (function nodename$stately$communications$re_frame_api$log(p1__64422_SHARP_){
return console.log(p1__64422_SHARP_);
});
nodename.stately.communications.re_frame_api.warn = (function nodename$stately$communications$re_frame_api$warn(p1__64425_SHARP_){
return console.warn(p1__64425_SHARP_);
});
nodename.stately.communications.re_frame_api.error = (function nodename$stately$communications$re_frame_api$error(p1__64428_SHARP_){
return console.error(p1__64428_SHARP_);
});
