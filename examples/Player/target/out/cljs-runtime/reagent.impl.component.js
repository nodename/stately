...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__60851 = c;
var G__60851__$1 = (((G__60851 == null))?null:G__60851.prototype);
if((G__60851__$1 == null)){
return null;
} else {
return G__60851__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__60855 = c;
var G__60855__$1 = (((G__60855 == null))?null:G__60855.prototype);
if((G__60855__$1 == null)){
return null;
} else {
return G__60855__$1.render;
}
})() == null)))));
});
...
var G__60871 = c;
var G__60871__$1 = (((G__60871 == null))?null:G__60871.constructor);
if((G__60871__$1 == null)){
return null;
} else {
return G__60871__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__60898 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__60899 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__60899);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__60898);
}});
...
var G__60903 = reagent.impl.component.goog$module$goog$object.get(component_state,"cljsRatom");
if((G__60903 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__60903);
}
} else {
return null;
}
...
var G__60921 = key;
var G__60921__$1 = (((G__60921 instanceof cljs.core.Keyword))?G__60921.fqn:null);
switch (G__60921__$1) {
...
var renders_61174 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_61175 = cljs.core.first(cljs.core.vals(renders_61174));
...
if((cljs.core.count(renders_61174) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_61174))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_61175)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_61175], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__61013 = o;
reagent.impl.component.goog$module$goog$object.set(G__61013,cljs.core.name(k),v);
...
return (function() { 
var G__61204__delegate = function (args){
return reagent.impl.protocols.as_element(compiler,cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args));
};
var G__61204 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__61205__i = 0, G__61205__a = new Array(arguments.length -  0);
while (G__61205__i < G__61205__a.length) {G__61205__a[G__61205__i] = arguments[G__61205__i + 0]; ++G__61205__i;}
  args = new cljs.core.IndexedSeq(G__61205__a,0,null);
} 
return G__61204__delegate.call(this,args);};
G__61204.cljs$lang$maxFixedArity = 0;
G__61204.cljs$lang$applyTo = (function (arglist__61206){
var args = cljs.core.seq(arglist__61206);
return G__61204__delegate(args);
});
G__61204.cljs$core$IFn$_invoke$arity$variadic = G__61204__delegate;
return G__61204;
})()
...
var _STAR_current_component_STAR__orig_val__61048 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__61049 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__61049);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__61048);
}});
...
var vec__61054 = module$node_modules$react$index.useReducer(cljs.core.inc,(0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61054,(0),null);
var force_update = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61054,(1),null);
