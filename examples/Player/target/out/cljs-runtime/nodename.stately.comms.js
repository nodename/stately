...
var fexpr__64496 = new cljs.core.Keyword(null,"dispatch","dispatch",1319337009).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(nodename.stately.comms.comms));
return (fexpr__64496.cljs$core$IFn$_invoke$arity$1 ? fexpr__64496.cljs$core$IFn$_invoke$arity$1(event_v) : fexpr__64496.call(null, event_v));
});
nodename.stately.comms.run_queue = (function nodename$stately$comms$run_queue(){
var fexpr__64502 = new cljs.core.Keyword(null,"run-queue","run-queue",-1701798027).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(nodename.stately.comms.comms));
return (fexpr__64502.cljs$core$IFn$_invoke$arity$0 ? fexpr__64502.cljs$core$IFn$_invoke$arity$0() : fexpr__64502.call(null, ));
});
...
var fexpr__64547 = new cljs.core.Keyword(null,"register-handler","register-handler",628654776).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(nodename.stately.comms.comms));
return (fexpr__64547.cljs$core$IFn$_invoke$arity$2 ? fexpr__64547.cljs$core$IFn$_invoke$arity$2(id,handler) : fexpr__64547.call(null, id,handler));
}));

(nodename.stately.comms.register_handler.cljs$core$IFn$_invoke$arity$3 = (function (id,middleware,handler){
var fexpr__64565 = new cljs.core.Keyword(null,"register-handler","register-handler",628654776).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(nodename.stately.comms.comms));
return (fexpr__64565.cljs$core$IFn$_invoke$arity$3 ? fexpr__64565.cljs$core$IFn$_invoke$arity$3(id,middleware,handler) : fexpr__64565.call(null, id,middleware,handler));
}));
...
var fexpr__64569 = new cljs.core.Keyword(null,"lookup-handler","lookup-handler",-72721902).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(nodename.stately.comms.comms));
return (fexpr__64569.cljs$core$IFn$_invoke$arity$1 ? fexpr__64569.cljs$core$IFn$_invoke$arity$1(event_id) : fexpr__64569.call(null, event_id));
});
nodename.stately.comms.log = (function nodename$stately$comms$log(var_args){
var args__5732__auto__ = [];
var len__5726__auto___64674 = arguments.length;
var i__5727__auto___64675 = (0);
while(true){
if((i__5727__auto___64675 < len__5726__auto___64674)){
args__5732__auto__.push((arguments[i__5727__auto___64675]));

var G__64677 = (i__5727__auto___64675 + (1));
i__5727__auto___64675 = G__64677;
continue;
} else {
}
break;
...
var G__64614 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [args], null);
var fexpr__64613 = new cljs.core.Keyword(null,"log","log",-1595516004).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(nodename.stately.comms.comms));
return (fexpr__64613.cljs$core$IFn$_invoke$arity$1 ? fexpr__64613.cljs$core$IFn$_invoke$arity$1(G__64614) : fexpr__64613.call(null, G__64614));
}));

(nodename.stately.comms.log.cljs$lang$maxFixedArity = (0));

/** @this {Function} */
(nodename.stately.comms.log.cljs$lang$applyTo = (function (seq64604){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq64604));
}));
...
var G__64631 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [args], null);
var fexpr__64630 = new cljs.core.Keyword(null,"warn","warn",-436710552).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(nodename.stately.comms.comms));
return (fexpr__64630.cljs$core$IFn$_invoke$arity$1 ? fexpr__64630.cljs$core$IFn$_invoke$arity$1(G__64631) : fexpr__64630.call(null, G__64631));
}));

(nodename.stately.comms.warn.cljs$lang$maxFixedArity = (0));

/** @this {Function} */
(nodename.stately.comms.warn.cljs$lang$applyTo = (function (seq64617){
var self__5712__auto__ = this;
...
var args__5732__auto__ = [];
var len__5726__auto___64687 = arguments.length;
var i__5727__auto___64688 = (0);
while(true){
if((i__5727__auto___64688 < len__5726__auto___64687)){
args__5732__auto__.push((arguments[i__5727__auto___64688]));

var G__64689 = (i__5727__auto___64688 + (1));
i__5727__auto___64688 = G__64689;
continue;
} else {
}
break;
...
var G__64647 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [args], null);
var fexpr__64646 = new cljs.core.Keyword(null,"error","error",-978969032).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(nodename.stately.comms.comms));
return (fexpr__64646.cljs$core$IFn$_invoke$arity$1 ? fexpr__64646.cljs$core$IFn$_invoke$arity$1(G__64647) : fexpr__64646.call(null, G__64647));
}));

(nodename.stately.comms.error.cljs$lang$maxFixedArity = (0));

/** @this {Function} */
(nodename.stately.comms.error.cljs$lang$applyTo = (function (seq64635){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq64635));
}));
