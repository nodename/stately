...
re_frame.flow.alpha.input_ids = (function re_frame$flow$alpha$input_ids(p__44833){
var map__44835 = p__44833;
var map__44835__$1 = cljs.core.__destructure_map(map__44835);
var inputs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44835__$1,new cljs.core.Keyword(null,"inputs","inputs",865803858));
var live_inputs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44835__$1,new cljs.core.Keyword(null,"live-inputs","live-inputs",1350889395));
return cljs.core.vec(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.remove.cljs$core$IFn$_invoke$arity$1(re_frame.flow.alpha.db_path_QMARK_),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__44832_SHARP_){
var or__5002__auto__ = new cljs.core.Keyword("re-frame.flow.alpha","flow<-","re-frame.flow.alpha/flow<-",1540916150).cljs$core$IFn$_invoke$arity$1(p1__44832_SHARP_);
...
re_frame.flow.alpha.stale_in_flows = (function re_frame$flow$alpha$stale_in_flows(flows,p__44848){
var map__44849 = p__44848;
var map__44849__$1 = cljs.core.__destructure_map(map__44849);
var inputs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44849__$1,new cljs.core.Keyword(null,"inputs","inputs",865803858));
return cljs.core.reduce_kv((function (m,k,p__44852){
var map__44853 = p__44852;
var map__44853__$1 = cljs.core.__destructure_map(map__44853);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44853__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var G__44855 = m;
if(cljs.core.contains_QMARK_(cljs.core.set(cljs.core.vals(inputs)),path)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__44855,k,path);
} else {
return G__44855;
}
}),cljs.core.PersistentArrayMap.EMPTY,flows);
});
re_frame.flow.alpha.stale_out_flows = (function re_frame$flow$alpha$stale_out_flows(flows,p__44858){
var map__44859 = p__44858;
var map__44859__$1 = cljs.core.__destructure_map(map__44859);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44859__$1,new cljs.core.Keyword(null,"path","path",-188191168));
return cljs.core.reduce_kv((function (m,k,p__44860){
var map__44861 = p__44860;
var map__44861__$1 = cljs.core.__destructure_map(map__44861);
var inputs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44861__$1,new cljs.core.Keyword(null,"inputs","inputs",865803858));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__44862,k,bad_inputs);
} else {
return G__44862;
}
}),cljs.core.PersistentArrayMap.EMPTY,flows);
});
re_frame.flow.alpha.validate_inputs = (function re_frame$flow$alpha$validate_inputs(p__44867){
var map__44868 = p__44867;
var map__44868__$1 = cljs.core.__destructure_map(map__44868);
var inputs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44868__$1,new cljs.core.Keyword(null,"inputs","inputs",865803858));
var seq__44870 = cljs.core.seq(inputs);
var chunk__44872 = null;
var count__44873 = (0);
var i__44874 = (0);
while(true){
if((i__44874 < count__44873)){
var vec__44887 = chunk__44872.cljs$core$IIndexed$_nth$arity$2(null, i__44874);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44887,(0),null);
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44887,(1),null);
...
var G__45103 = seq__44870;
var G__45104 = chunk__44872;
var G__45105 = count__44873;
var G__45106 = (i__44874 + (1));
seq__44870 = G__45103;
chunk__44872 = G__45104;
count__44873 = G__45105;
i__44874 = G__45106;
continue;
} else {
var G__45109 = seq__44870;
var G__45110 = chunk__44872;
var G__45111 = count__44873;
var G__45112 = (i__44874 + (1));
seq__44870 = G__45109;
chunk__44872 = G__45110;
count__44873 = G__45111;
i__44874 = G__45112;
continue;
}
} else {
var temp__5804__auto__ = cljs.core.seq(seq__44870);
if(temp__5804__auto__){
var seq__44870__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__44870__$1)){
var c__5525__auto__ = cljs.core.chunk_first(seq__44870__$1);
var G__45115 = cljs.core.chunk_rest(seq__44870__$1);
var G__45116 = c__5525__auto__;
var G__45117 = cljs.core.count(c__5525__auto__);
var G__45118 = (0);
seq__44870 = G__45115;
chunk__44872 = G__45116;
count__44873 = G__45117;
i__44874 = G__45118;
continue;
} else {
var vec__44893 = cljs.core.first(seq__44870__$1);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44893,(0),null);
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44893,(1),null);
if(cljs.core.not(cljs.core.some_fn.cljs$core$IFn$_invoke$arity$2(re_frame.flow.alpha.db_path_QMARK_,re_frame.flow.alpha.flow_LT___QMARK_)(input))){
throw (new Error("bad input"));


var G__45120 = cljs.core.next(seq__44870__$1);
var G__45121 = null;
var G__45122 = (0);
var G__45123 = (0);
seq__44870 = G__45120;
chunk__44872 = G__45121;
count__44873 = G__45122;
i__44874 = G__45123;
continue;
} else {
var G__45124 = cljs.core.next(seq__44870__$1);
var G__45125 = null;
var G__45126 = (0);
var G__45127 = (0);
seq__44870 = G__45124;
chunk__44872 = G__45125;
count__44873 = G__45126;
i__44874 = G__45127;
continue;
}
}
...
var warn_ins = (function (p__44922){
var vec__44923 = p__44922;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44923,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44923,(1),null);
...
var warn_outs = (function (p__44929){
var vec__44930 = p__44929;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44930,(0),null);
var inputs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44930,(1),null);
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__44933){
var vec__44935 = p__44933;
var input_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44935,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44935,(1),null);
...
re_frame.flow.alpha.do_effect = (function re_frame$flow$alpha$do_effect(p__44972){
var vec__44974 = p__44972;
...
var handler = (function (){var G__44979 = k;
...
re_frame.flow.alpha.dissoc_fx = (function re_frame$flow$alpha$dissoc_fx(p1__44986_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc,p1__44986_SHARP_,re_frame.flow.alpha.flow_fx_ids);
});
...
var ctx = map__44990__$1;
var map__44992 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44990__$1,new cljs.core.Keyword(null,"effects","effects",-282369292));
var map__44992__$1 = cljs.core.__destructure_map(map__44992);
var effects = map__44992__$1;
var fx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44992__$1,new cljs.core.Keyword(null,"fx","fx",-1237829572));
...
var G__44998 = input;
var G__44998__$1 = (((G__44998 == null))?null:new cljs.core.Keyword("re-frame.flow.alpha","flow<-","re-frame.flow.alpha/flow<-",1540916150).cljs$core$IFn$_invoke$arity$1(G__44998));
var G__44998__$2 = (((G__44998__$1 == null))?null:(flows.cljs$core$IFn$_invoke$arity$1 ? flows.cljs$core$IFn$_invoke$arity$1(G__44998__$1) : flows.call(null, G__44998__$1)));
var G__44998__$3 = (((G__44998__$2 == null))?null:new cljs.core.Keyword(null,"path","path",-188191168).cljs$core$IFn$_invoke$arity$1(G__44998__$2));
if((G__44998__$3 == null)){
return null;
} else {
return (re_frame.flow.alpha.resolve_input.cljs$core$IFn$_invoke$arity$3 ? re_frame.flow.alpha.resolve_input.cljs$core$IFn$_invoke$arity$3(db,flows,G__44998__$3) : re_frame.flow.alpha.resolve_input.call(null, db,flows,G__44998__$3));
}
}
});
...
re_frame.flow.alpha.run = (function re_frame$flow$alpha$run(ctx,p__45009){
var map__45013 = p__45009;
var map__45013__$1 = cljs.core.__destructure_map(map__45013);
var flow = map__45013__$1;
var live_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45013__$1,new cljs.core.Keyword(null,"live?","live?",-1539352230));
var cleanup = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45013__$1,new cljs.core.Keyword(null,"cleanup","cleanup",1045776959));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45013__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var cleared_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45013__$1,new cljs.core.Keyword("re-frame.flow.alpha","cleared?","re-frame.flow.alpha/cleared?",1524733548));
var output = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45013__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var flow_fx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45013__$1,new cljs.core.Keyword(null,"fx","fx",-1237829572));
var inputs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45013__$1,new cljs.core.Keyword(null,"inputs","inputs",865803858));
var live_inputs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45013__$1,new cljs.core.Keyword(null,"live-inputs","live-inputs",1350889395));
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45013__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
...
var bardo = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [((new_QMARK_)?new cljs.core.Keyword(null,"registered","registered",-388600037):(cljs.core.truth_((function (){var G__45047 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(id__GT_old_live_in,new cljs.core.Keyword(null,"db","db",993250759),old_db);
return (live_QMARK_.cljs$core$IFn$_invoke$arity$1 ? live_QMARK_.cljs$core$IFn$_invoke$arity$1(G__45047) : live_QMARK_.call(null, G__45047));
})())?new cljs.core.Keyword(null,"live","live",-1610148039):new cljs.core.Keyword(null,"dead","dead",-1946604091)
)),(cljs.core.truth_(cleared_QMARK_)?new cljs.core.Keyword(null,"cleared","cleared",-1267667336):(cljs.core.truth_((function (){var G__45049 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(id__GT_live_in,new cljs.core.Keyword(null,"db","db",993250759),db);
return (live_QMARK_.cljs$core$IFn$_invoke$arity$1 ? live_QMARK_.cljs$core$IFn$_invoke$arity$1(G__45049) : live_QMARK_.call(null, G__45049));
})())?new cljs.core.Keyword(null,"live","live",-1610148039):new cljs.core.Keyword(null,"dead","dead",-1946604091)
))], null);
var new_db = (function (){var G__45052 = bardo;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"live","live",-1610148039),new cljs.core.Keyword(null,"live","live",-1610148039)], null),G__45052)){
var G__45055 = db;
if(dirty_QMARK_){
return cljs.core.assoc_in(G__45055,path,(output.cljs$core$IFn$_invoke$arity$3 ? output.cljs$core$IFn$_invoke$arity$3(id__GT_in,id__GT_old_in,old_output) : output.call(null, id__GT_in,id__GT_old_in,old_output)));
} else {
return G__45055;
}
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"live","live",-1610148039),new cljs.core.Keyword(null,"dead","dead",-1946604091)], null),G__45052)){
return (cleanup.cljs$core$IFn$_invoke$arity$2 ? cleanup.cljs$core$IFn$_invoke$arity$2(db,path) : cleanup.call(null, db,path));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"dead","dead",-1946604091),new cljs.core.Keyword(null,"live","live",-1610148039)], null),G__45052)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"registered","registered",-388600037),new cljs.core.Keyword(null,"live","live",-1610148039)], null),G__45052)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"live","live",-1610148039),new cljs.core.Keyword(null,"cleared","cleared",-1267667336)], null),G__45052)){
return (cleanup.cljs$core$IFn$_invoke$arity$2 ? cleanup.cljs$core$IFn$_invoke$arity$2(db,path) : cleanup.call(null, db,path));
} else {
return null;
...
var new_fx = (cljs.core.truth_(flow_fx)?(function (){var G__45060 = bardo;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"live","live",-1610148039),new cljs.core.Keyword(null,"live","live",-1610148039)], null),G__45060)){
if(dirty_QMARK_){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"dead","dead",-1946604091),new cljs.core.Keyword(null,"live","live",-1610148039)], null),G__45060)){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fx,(flow_fx.cljs$core$IFn$_invoke$arity$3 ? flow_fx.cljs$core$IFn$_invoke$arity$3(id__GT_in,id__GT_old_in,old_output) : flow_fx.call(null, id__GT_in,id__GT_old_in,old_output)));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"registered","registered",-388600037),new cljs.core.Keyword(null,"live","live",-1610148039)], null),G__45060)){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fx,(flow_fx.cljs$core$IFn$_invoke$arity$3 ? flow_fx.cljs$core$IFn$_invoke$arity$3(id__GT_in,id__GT_old_in,old_output) : flow_fx.call(null, id__GT_in,id__GT_old_in,old_output)));
} else {
return null;
...
try{try{var G__45068 = ctx;
var G__45068__$1 = (cljs.core.truth_(new_db)?re_frame.interceptor.assoc_effect(G__45068,new cljs.core.Keyword(null,"db","db",993250759),new_db):G__45068);
if(cljs.core.truth_(new_fx)){
return re_frame.interceptor.assoc_effect(G__45068__$1,new cljs.core.Keyword(null,"fx","fx",-1237829572),new_fx);
} else {
return G__45068__$1;
}
}finally {if(re_frame.trace.is_trace_enabled_QMARK_()){
var end__12884__auto___45224 = re_frame.interop.now();
var duration__12885__auto___45225 = (end__12884__auto___45224 - new cljs.core.Keyword(null,"start","start",-355208981).cljs$core$IFn$_invoke$arity$1(re_frame.trace._STAR_current_trace_STAR_));
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(re_frame.trace.traces,cljs.core.conj,cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(re_frame.trace._STAR_current_trace_STAR_,new cljs.core.Keyword(null,"duration","duration",1444101068),duration__12885__auto___45225,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"end","end",-268185958),re_frame.interop.now()], 0)));

re_frame.trace.run_tracing_callbacks_BANG_(end__12884__auto___45224);
} else {
}
}}finally {(re_frame.trace._STAR_current_trace_STAR_ = _STAR_current_trace_STAR__orig_val__45064);
}} else {
var G__45069 = ctx;
var G__45069__$1 = (cljs.core.truth_(new_db)?re_frame.interceptor.assoc_effect(G__45069,new cljs.core.Keyword(null,"db","db",993250759),new_db):G__45069);
if(cljs.core.truth_(new_fx)){
return re_frame.interceptor.assoc_effect(G__45069__$1,new cljs.core.Keyword(null,"fx","fx",-1237829572),new_fx);
} else {
return G__45069__$1;
}
}
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.update_vals(new cljs.core.Keyword("re-frame.flow.alpha","cleared","re-frame.flow.alpha/cleared",234911327).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(re_frame.flow.alpha.flow_states)),(function (p1__45072_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__45072_SHARP_,new cljs.core.Keyword("re-frame.flow.alpha","cleared?","re-frame.flow.alpha/cleared?",1524733548),true);
})),m], 0));
});
...
var ctx = map__45079__$1;
var map__45080 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45079__$1,new cljs.core.Keyword(null,"effects","effects",-282369292));
