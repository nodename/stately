...
var i_42177 = (0);
while(true){
if((i_42177 < arr.length)){
(arr[i_42177] = null);

var G__42178 = (i_42177 + (1));
i_42177 = G__42178;
continue;
} else {
}
...
var i_42190 = (self__.level + (1));
while(true){
if((i_42190 <= (new_level + (1)))){
(update[i_42190] = self__.header);

var G__42191 = (i_42190 + (1));
i_42190 = G__42191;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_42194 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_42194[i]));
} else {
x__$2.forward.push((((i < links_42194.length))?(links_42194[i]):null));
}

if((i < links_42194.length)){
(links_42194[i] = x__$2);
} else {
links_42194.push(x__$2);
}
...
var i_42201 = (0);
while(true){
if((i_42201 <= self__.level)){
var links_42202 = (update[i_42201]).forward;
if((x__$1 === (((i_42201 < links_42202.length))?(links_42202[i_42201]):null))){
(links_42202[i_42201] = (x__$1.forward[i_42201]));

var G__42203 = (i_42201 + (1));
i_42201 = G__42203;
continue;
} else {
var G__42204 = (i_42201 + (1));
i_42201 = G__42204;
continue;
}
} else {
...
var G__42212 = nx;
var G__42213 = (level__$1 - (1));
x = G__42212;
level__$1 = G__42213;
continue;
} else {
var G__42215 = x;
var G__42216 = (level__$1 - (1));
x = G__42215;
level__$1 = G__42216;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__42218 = nx;
var G__42219 = (level__$1 - (1));
x = G__42218;
level__$1 = G__42219;
continue;
} else {
var G__42220 = x;
var G__42221 = (level__$1 - (1));
x = G__42220;
level__$1 = G__42221;
continue;
}
