...
var G__42173 = shadow_root.activeElement;
active_element = G__42173;
continue;
} else {
...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__42138){
var map__42139 = p__42138;
var map__42139__$1 = cljs.core.__destructure_map(map__42139);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42139__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
var _STAR_force_set_dom_value_STAR__orig_val__42144 = reagent.impl.input._STAR_force_set_dom_value_STAR_;
var _STAR_force_set_dom_value_STAR__temp_val__42145 = true;
(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__temp_val__42145);
...
}finally {(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__orig_val__42144);
}}));
} else {
...
(jsprops.onChange = (function (p1__42158_SHARP_){
return reagent.impl.input.input_handle_change(this$,on_change,p1__42158_SHARP_);
}));
