...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__41891 = c;
var G__41891__$1 = (((G__41891 == null))?null:G__41891.prototype);
if((G__41891__$1 == null)){
return null;
} else {
return G__41891__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__41898 = c;
var G__41898__$1 = (((G__41898 == null))?null:G__41898.prototype);
if((G__41898__$1 == null)){
return null;
} else {
return G__41898__$1.render;
}
})() == null)))));
});
...
var or__5002__auto__ = (function (){var G__41912 = c;
var G__41912__$1 = (((G__41912 == null))?null:G__41912.constructor);
if((G__41912__$1 == null)){
return null;
} else {
return G__41912__$1.displayName;
}
})();
...
var G__41913 = c;
var G__41913__$1 = (((G__41913 == null))?null:G__41913.constructor);
if((G__41913__$1 == null)){
return null;
} else {
return G__41913__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__41952 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__41953 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__41953);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__41952);
}});
...
var G__41972 = reagent.impl.component.goog$module$goog$object.get(component_state,"cljsRatom");
if((G__41972 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__41972);
}
} else {
return null;
}
...
var renders_42175 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_42176 = cljs.core.first(cljs.core.vals(renders_42175));
...
if((cljs.core.count(renders_42175) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_42175))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_42176)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_42176], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__42039 = o;
reagent.impl.component.goog$module$goog$object.set(G__42039,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__42108 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__42109 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__42109);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__42108);
}});
...
var vec__42116 = module$node_modules$react$index.useReducer(cljs.core.inc,(0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42116,(0),null);
var force_update = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42116,(1),null);
