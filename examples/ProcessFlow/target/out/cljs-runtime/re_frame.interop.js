...
return [(function (){var pred__43037 = cljs.core.instance_QMARK_;
var expr__43038 = reactive_val;
if(cljs.core.truth_((pred__43037.cljs$core$IFn$_invoke$arity$2 ? pred__43037.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__43038) : pred__43037.call(null, reagent.ratom.RAtom,expr__43038)))){
return "ra";
} else {
if(cljs.core.truth_((pred__43037.cljs$core$IFn$_invoke$arity$2 ? pred__43037.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__43038) : pred__43037.call(null, reagent.ratom.RCursor,expr__43038)))){
return "rc";
} else {
if(cljs.core.truth_((pred__43037.cljs$core$IFn$_invoke$arity$2 ? pred__43037.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__43038) : pred__43037.call(null, reagent.ratom.Reaction,expr__43038)))){
return "rx";
} else {
if(cljs.core.truth_((pred__43037.cljs$core$IFn$_invoke$arity$2 ? pred__43037.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__43038) : pred__43037.call(null, reagent.ratom.Track,expr__43038)))){
return "tr";
} else {
return "other";
}
